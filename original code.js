  ...
  fetch(
    ...
    .then((json) => {
      if (json.cod == "404") {
        ...
        if (isDesktop) {
          container.style.height = "400px"; // Desktop error height
        } else {
          container.style.height = "310px"; // Mobile error height
        }
        ...
        return;
         ...
         const isDesktop = window.matchMedia("(min-width: 720px)").matches;
        if (isDesktop) {
          container.style.height = "555px"; // Desktop error height
        } else {
          container.style.height = "400px"; // Mobile error height
        }
      }
